...
class FrontControllerProvider implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
		...
		$c->match('/mypage/exportReceipt/{id}', '\Eccube\Controller\Mypage\MypageController::exportReceipt')->bind('mypage_export_receipt')->assert('id', '\d+');
        ...
        $c->match('/mypage/video/{id}', '\Eccube\Controller\Mypage\MypageController::video')->bind('mypage_video')->assert('id', '\d+');
