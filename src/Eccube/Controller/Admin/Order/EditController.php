...
class EditController extends AbstractController
{
    ...
    /**
     * 受注ステータスが入金済になったら行う処理
     *
     * 注文者情報のメールアドレスから
     * WPポータルの登録者と紐づけWPデータのランクを更新
     *
     * @param $app
     * @param $TargetOrder
     * @param $OriginOrder
     */
    protected function wptsupdate()
    {
			$dbh = new PDO("mysql:host=localhost; dbname=wp614605_wt2; charset=utf8", "wp614605_wt2", "68e81555ab");
			$stmt = $dbh->prepare('UPDATE wp_postmeta SET ts = :ts WHERE t_mail = :wpmail');
			$stmt->execute(array(':ts' => '0', ':wpmail' => 'linked.d.web@gmail.com'));
			$dbh = null;
    }
}
