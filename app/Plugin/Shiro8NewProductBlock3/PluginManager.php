...
namespace Plugin\Shiro8NewProductBlock3;
...
class PluginManager extends AbstractPluginManager
{
     ...
     * @var string ブロック名
     */
    private $blockName = '新着商品ブロック';

    /**
     * @var string ブロックファイル名
     */
    private $blockFileName = 'plg_shiro8_new_product_block';
    ...
    private function copyBlock($app)
    {
        ...
        $file->mkdir($app['config']['plugin_html_realdir'] . '/Shiro8NewProductBlock3/css/', 0775);
        $file->mkdir($app['config']['plugin_html_realdir'] . '/Shiro8NewProductBlock3/img_faq/', 0775);
        $file->mkdir($app['config']['plugin_html_realdir'] . '/Shiro8NewProductBlock3/js/', 0775);
    ...
    private function removeBlock($app)
    {
        ...
        $file->remove($app['config']['plugin_html_realdir'] . '/Shiro8NewProductBlock3');
