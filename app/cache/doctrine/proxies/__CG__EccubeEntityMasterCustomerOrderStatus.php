...
class CustomerOrderStatus extends \Eccube\Entity\Master\CustomerOrderStatus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Master\\CustomerOrderStatus' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Master\\CustomerOrderStatus' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Master\\CustomerOrderStatus' . "\0" . 'rank');
        }
