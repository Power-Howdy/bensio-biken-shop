...
namespace DoctrineProxy\__CG__\Plugin\EccubePaymentLite3\Entity\Master;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DeliveryCompany extends \Plugin\EccubePaymentLite3\Entity\Master\DeliveryCompany implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Plugin\\EccubePaymentLite3\\Entity\\Master\\DeliveryCompany' . "\0" . 'id', '' . "\0" . 'Plugin\\EccubePaymentLite3\\Entity\\Master\\DeliveryCompany' . "\0" . 'name', '' . "\0" . 'Plugin\\EccubePaymentLite3\\Entity\\Master\\DeliveryCompany' . "\0" . 'rank');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DeliveryCompany $proxy) {
