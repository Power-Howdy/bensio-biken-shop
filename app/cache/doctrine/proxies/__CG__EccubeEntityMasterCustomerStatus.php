...
class CustomerStatus extends \Eccube\Entity\Master\CustomerStatus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Master\\CustomerStatus' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Master\\CustomerStatus' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Master\\CustomerStatus' . "\0" . 'rank');
        }
