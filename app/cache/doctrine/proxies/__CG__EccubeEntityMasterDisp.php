 ...
 */
class Disp extends \Eccube\Entity\Master\Disp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Master\\Disp' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Master\\Disp' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Master\\Disp' . "\0" . 'rank');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Disp $proxy) {
