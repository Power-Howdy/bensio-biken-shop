 ...
 */
class ProductType extends \Eccube\Entity\Master\ProductType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Master\\ProductType' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Master\\ProductType' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Master\\ProductType' . "\0" . 'rank');
        }
