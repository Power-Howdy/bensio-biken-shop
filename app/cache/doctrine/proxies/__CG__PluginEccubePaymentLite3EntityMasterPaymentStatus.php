 ...
 */
class PaymentStatus extends \Plugin\EccubePaymentLite3\Entity\Master\PaymentStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Plugin\\EccubePaymentLite3\\Entity\\Master\\PaymentStatus' . "\0" . 'id', '' . "\0" . 'Plugin\\EccubePaymentLite3\\Entity\\Master\\PaymentStatus' . "\0" . 'name', '' . "\0" . 'Plugin\\EccubePaymentLite3\\Entity\\Master\\PaymentStatus' . "\0" . 'rank');
        }
