 ...
 */
class Tag extends \Eccube\Entity\Master\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Master\\Tag' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Master\\Tag' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Master\\Tag' . "\0" . 'rank', '' . "\0" . 'Eccube\\Entity\\Master\\Tag' . "\0" . 'ProductTag');
        }
